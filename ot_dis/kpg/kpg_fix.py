...
class KeyPointGuidedOT(object):
    ...
    def kpg_rl_kp(self,p,q,xs,xt,K,cost_function="L2",algorithm="linear_programming",reg=0.0001,max_iterations=100000,eps=1e-10,thres=1e-5):
        '''
